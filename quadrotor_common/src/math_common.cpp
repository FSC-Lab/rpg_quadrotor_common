...
Eigen::Affine3d lowpass(const Eigen::Affine3d& filterin,
  ...
  Eigen::Affine3d filter_out =
      Eigen::Translation3d(filter_out_position) * filter_out_orientation;
  return filter_out;
}
...
double degToRad(const double deg) { return 0.017453292519943 * deg; }

double radToDeg(const double rad) { return 57.295779513082323 * rad; }
